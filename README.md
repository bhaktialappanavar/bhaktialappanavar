...
Welcome to my GitHub! I enjoy building full-stack web applications and AI-powered solutions using Python, Django, Flask, JavaScript, and modern web technologies.
...
- 🌱 Currently learning Django, Flask, JavaScript, and AI
- 🤖 Interested in AI-Powered Web Applications
- 🎯 Goal: Become the software Developer
...
🤖 AI-Based Chatbot for College Website
• Flask, Gemini API, HTML, CSS, JavaScript

🎓 Campus Placement Portal
• Flask, MongoDB, AI Resume Analysis
...
<!--
**bhaktialappanavar/bhaktialappanavar** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
